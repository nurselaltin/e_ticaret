...
if(post('submit')){
    ...
    $query = $db->prepare('INSERT INTO product SET product_title = :title , product_description = :description,product_img = :img ,product_count = :product_count ,product_color = :product_color,   product_size = :product_size, is_public=:is_public');
